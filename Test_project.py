...
from railnetwork import Railroad_Network
...
def route_info(_from, to, steps):
    current_station = _from
    counter = 0
    if current_station.is_next(to) == True:
        #....do something here...
        pass
    else:
        for connection in _from.get_connections:    
            current_station = connection.get_to()
